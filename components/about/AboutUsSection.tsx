          ...
          <div className="w-full md:w-6/12 lg:w-3/12 px-4">
            <div className="text-start mx-auto">
              <p className="text-base">
                ...
                this mission forward in the heart of the Midwest. As one of the
                largest public universities in the nation, we leverage
              ...
              <p className="text-base">
                ...
                excellence among underrepresented students in computing fields.
                Our membership is open to all students passionate about
                increasing diversity in technology, regardless of major,
            ...
            <div className="text-start mx-auto">
              ...
              <div className="text-base">
                ...
                <p>
                  ...
                  Talk to an e-board member for a referral or visit{" "}
                  <a
